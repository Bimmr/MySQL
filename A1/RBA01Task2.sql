...
SELECT item_id, item_price, discount_amount, quantity, (item_price * quantity) AS 'item_price', (discount_amount * quantity) AS 'discount_total', ((item_price - discount_amount) * quantity) AS ' item_total'
FROM order_items
...
SELECT 100 AS 'price', 0.7 AS 'tax_rate', (100*0.07) AS 'tax_amount', (100*1.07) AS ' total';
